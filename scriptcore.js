...
// อัปเดตล่าสุด: รวมข้อมูลพืชเศรษฐกิจ (รวมอินทผาลัม) และธุรกิจ SME (รวมหมูปิ้ง) ครบถ้วน
...
(function(global) {
    ...
    const MOCK_CROPS = [
        ...
        // --- ธุรกิจ SME / แฟรนไชส์ ---
        { name: "ร้านกาแฟ (Slow Bar)", category: "ธุรกิจ", price: 45, yield: 8000, cost: 180000, risk: "Medium", unit: "cup", yieldUnit: "แก้ว/ปี", market: "ลูกค้าทั่วไป", source: 'Mock' },
        { name: "แฟรนไชส์ลูกชิ้นทอด", category: "ธุรกิจ", price: 15, yield: 30000, cost: 250000, risk: "Low", unit: "stick", yieldUnit: "ไม้/ปี", market: "ตลาดนัด/ชุมชน", source: 'Mock' },
        { name: "ข้าวเหนียวหมูปิ้ง (สูตรนมสด)", category: "ธุรกิจ", price: 10, yield: 45000, cost: 280000, risk: "Low", unit: "stick", yieldUnit: "ไม้/ปี", market: "เช้า/เย็น", source: 'Mock' },
        { name: "โรงงานผักสลัด (Clean Food)", category: "ธุรกิจ", price: 150, yield: 6000, cost: 450000, risk: "Medium", unit: "box", yieldUnit: "กล่อง/ปี", market: "ออนไลน์/สุขภาพ", source: 'Mock' },
        { name: "Care Center (ศูนย์ดูแลผู้สูงอายุ)", category: "ธุรกิจ", price: 25000, yield: 48, cost: 800000, risk: "High", unit: "person", yieldUnit: "คน/ปี", market: "Aging Society", source: 'Mock' }
    ];
